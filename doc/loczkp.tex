...
To achive eexpected properties of Merkle-tree based scheme while keeping an option
...
Rather that priving ``distance is smaller than''~\eqref{eq-distn},
...
``Trajectrories are close enough'' proof \\
