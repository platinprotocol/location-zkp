...
This protocol enables a verifier to process a commitment and determine the difference,
which reflects whether the commitment reflects a position inside or outside the radius of the service area.
